...
import { UserPlus, MessageCircle, Music, Sparkles, Trophy, Calendar, MapPin, Users } from 'lucide-react-native';
...
const friendsWithExtra = [
  ...friends,
  { id: '6', name: 'lovelyVybz', avatar: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=200&h=200&fit=crop', bio: 'Pop & rock all day', mutualArtists: 4, tags: ['pop', 'rock'], online: true, level: 2 },
  { id: '7', name: 'indieVibes22', avatar: 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=200&h=200&fit=crop', bio: 'Indie is a lifestyle', mutualArtists: 6, tags: ['indie', 'rock'], online: false, level: 5 },
  { id: '8', name: 'beatMaster', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop', bio: 'Beats and rhymes forever', mutualArtists: 3, tags: ['hip-hop', 'rap'], online: true, level: 8 },
  { id: '9', name: 'jazzSoul', avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=200&h=200&fit=crop', bio: 'Smooth jazz and neo soul', mutualArtists: 5, tags: ['jazz', 'soul'], online: false, level: 4 },
];

function FriendGridCard({ friend, index }: { friend: typeof friendsWithExtra[0]; index: number }) {
  ...
  return (
    <Animated.View style={[styles.gridCardWrap, { opacity: fadeAnim, transform: [{ translateY: slideAnim }, { scale: scaleAnim }] }]}>
      <Pressable onPress={handlePress} style={styles.gridCard}>
        <View style={styles.gridCardImageWrap}>
          <Image source={{ uri: friend.avatar }} style={styles.gridCardImage} contentFit="cover" />
          {friend.online && <View style={styles.gridOnlineDot} />}
        </View>

        <View style={styles.gridCardBody}>
          <Text style={styles.gridCardName} numberOfLines={1}>{friend.name}</Text>
      ...
      >
            ...
            return (
              <Pressable
                ...
                onPress={() => {
                  ...
                  else if (action.id === 'requests') router.push('/friend-requests');
                  else if (action.id === 'leaderboard') router.push('/leaderboard');
                }}
              >
        ...
        <View style={styles.recommendedHeader}>
          ...
          <View>
            ...
            <Text style={styles.recommendedSub}>Based on similar music tastes</Text>
          </View>
        </View>
