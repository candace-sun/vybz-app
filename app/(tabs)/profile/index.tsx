      ...
      >
        <Animated.View style={{ opacity: fadeAnim }}>
          ...
          <View style={styles.profileCard}>
            ...
            <View style={styles.tagRow}>
              ...
              <View style={[styles.profileTag, { backgroundColor: 'rgba(255, 45, 120, 0.15)' }]}>
                <Text style={[styles.profileTagText, { color: theme.pink }]}>Lvl {userProfile.level}</Text>
              </View>
            </View>
            ...
            <View style={styles.xpSection}>
              <View style={styles.xpHeader}>
                ...
                <Text style={styles.xpCount}>{userProfile.xp}/{userProfile.xpToNext}</Text>
              </View>
          ...
          <View style={styles.statsRow}>
            <StatCard icon={<Zap size={18} color={theme.xpGold} />} value={userProfile.xp} label="Total XP" />
            <StatCard icon={<Coins size={18} color={theme.coinYellow} />} value={userProfile.coins} label="Coins" />
            <StatCard icon={<Sprout size={18} color={theme.neonGreen} />} value={userProfile.plantsGrown} label="Plants" />
            <StatCard icon={<Music size={18} color={theme.pink} />} value={userProfile.songsCollected} label="Songs" />
          </View>
            ...
            <View style={styles.settingsList}>
              {settingsRows.map((row, i) => (
                ...
                >
                  ...
                  <Text style={[styles.settingLabel, row.color ? { color: row.color } : null]}>{row.label}</Text>
